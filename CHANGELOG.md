...
## [9.0.0](https://github.com/max397574/neorg/compare/v8.5.0...v9.0.0) (2024-05-28)
...
* **concealer:** simpler config for ordered list icon & multichar icon for unordered list ([#1179](https://github.com/max397574/neorg/issues/1179))
...
* **selection_popup:** modernize code of selection popup ([310f3a4](https://github.com/max397574/neorg/commit/310f3a484d3d98b0d05650a38407dcaa7f090b96))


### Features

* add `integrations.coq_nvim` as a new completion engine ([b8f9f83](https://github.com/max397574/neorg/commit/b8f9f834d999a6807ee9476857fb3af2c58f64a2))
* add `integrations.otter` for LSP-like behaviours in code blocks ([#1329](https://github.com/max397574/neorg/issues/1329)) ([ccb7555](https://github.com/max397574/neorg/commit/ccb75557f8582e044c687452b8b249151f6e7098))
* add `traverse-link` Neorg mode ([#1170](https://github.com/max397574/neorg/issues/1170)) ([ed25267](https://github.com/max397574/neorg/commit/ed25267eec3b08a3de8bdb4b55243f869ea4b8fd))
* add basic build.lua ([efac9eb](https://github.com/max397574/neorg/commit/efac9eb8c16cfe5cd1a45705d2add4eca749e63f))
* add LaTex rendering for inline equations ([#1133](https://github.com/max397574/neorg/issues/1133)) ([b5393e8](https://github.com/max397574/neorg/commit/b5393e8bdcf704f660fa86cace89033c5fc95504))
* add lua-utils.nvim to the list of required rocks ([b7b9eda](https://github.com/max397574/neorg/commit/b7b9edad6a852f33a2ce99051c748823dabd28cc))
* add new dependencies for norgopolis ([0e88310](https://github.com/max397574/neorg/commit/0e883108d8c782335615cf2108a703847a1295d9))
* add support for inline link targets ([132b73b](https://github.com/max397574/neorg/commit/132b73bfacd3014dc8afb56ddf7eed8c7acf6d6d))
* allow arguments for `:Neorg generate-workspace-summary` ([#1156](https://github.com/max397574/neorg/issues/1156)) ([46741ed](https://github.com/max397574/neorg/commit/46741ede577392f36cad1cb8c8e6029fabb729f6))
* allow nested workspace summaries ([#1144](https://github.com/max397574/neorg/issues/1144)) ([a923055](https://github.com/max397574/neorg/commit/a9230559fb6871f1f62996f8e862876169432f08))
* allow upward paths in tangle ([265e6af](https://github.com/max397574/neorg/commit/265e6af8decbb30b0ee14aee373b1bfe9a78b858))
* auto complete links ([#1295](https://github.com/max397574/neorg/issues/1295)) ([bd12dac](https://github.com/max397574/neorg/commit/bd12dacc9cf561cbffc8d6f8f4b76aa9d734665b))
* basic checkhealth for configuration checking ([645cd0c](https://github.com/max397574/neorg/commit/645cd0c257b2fccc655a32d0b04aa706c96fb1a8))
* check for the existence of `vhyrro/luarocks.nvim` ([a5aa931](https://github.com/max397574/neorg/commit/a5aa93108999de75c8d075a0ee4dcc6a715a9e1a))
* **concealer:** add ability to disable spell checking in code blocks ([316403a](https://github.com/max397574/neorg/commit/316403ad1cbb665e7838f596384d44b1649f6c1b))
* **concealer:** add config for concealing numeric footnote title to superscript ([2a6fc9c](https://github.com/max397574/neorg/commit/2a6fc9c808f6d643bf7c2f911a767e4aac500560))
* **concealer:** add configuration for hrule start and end position ([3db316a](https://github.com/max397574/neorg/commit/3db316a33838eb0875eacd659af9d49bbd4aef39))
* **concealer:** add option for opening all folds by default ([#1049](https://github.com/max397574/neorg/issues/1049)) ([6bfcaeb](https://github.com/max397574/neorg/commit/6bfcaeb8f36e0e4d2ae52dbde5e18b39d2351d5e))
* **concealer:** code block background `min_width` ([#1328](https://github.com/max397574/neorg/issues/1328)) ([efac835](https://github.com/max397574/neorg/commit/efac8350f4afe0b49f278129ef92ffb0a02d1c6f))
* **concealer:** simpler config for ordered list icon & multichar icon for unordered list ([#1179](https://github.com/max397574/neorg/issues/1179)) ([da74d14](https://github.com/max397574/neorg/commit/da74d14f217dc81bc364758bbecea3c5e934ba60))
* **concealer:** use empty foldmethod on nightly releases (for full folding passthrough) ([086891d](https://github.com/max397574/neorg/commit/086891d396ac9fccd91faf1520f563b6eb9eb942))
* create `deps.json` for a universal list of Neorg dependencies ([a64c6af](https://github.com/max397574/neorg/commit/a64c6af4ac1ab4aa3a5de93d86111814125e3ed8))
* **dirman:** use pathlib for all dirman operations  ([#1354](https://github.com/max397574/neorg/issues/1354)) ([1190dc7](https://github.com/max397574/neorg/commit/1190dc78b9785ad75301de9153ed8de83c179b66))
* **document.meta:** indent items of incomplete lists/objects for nicer writing experience ([92f2e9d](https://github.com/max397574/neorg/commit/92f2e9d4a7bfdbb7ed0e9dcd9b8768db63188149))
* **esupports.hop:** add open mode for external link target ([#1072](https://github.com/max397574/neorg/issues/1072)) ([851a3a2](https://github.com/max397574/neorg/commit/851a3a2b3cea5335fca233273d3c8861a017da14))
* **esupports:** use `wslview` to open `wsl2` files ([#1038](https://github.com/max397574/neorg/issues/1038)) ([20502e5](https://github.com/max397574/neorg/commit/20502e50e9087248f6f8ed8d29fae9c849c1c77f))
* **export.markdown:** option to export latex `embed` tags ([0abe7b7](https://github.com/max397574/neorg/commit/0abe7b737d35f2abd082bc6f694cf5a9fc166fb7))
* fix build.lua process (maybe once and for all?) ([eea6263](https://github.com/max397574/neorg/commit/eea6263ac4f3506d34d6e79839606e60b074757b))
* **hop:** feed wslview with decoded link ([c3b9653](https://github.com/max397574/neorg/commit/c3b965340f380740a12432536d2b23ee6c7564f9))
* implement the basics of the new todo introspector ([a7ad515](https://github.com/max397574/neorg/commit/a7ad51519f2e7a7274c069e35d4396a0a5f88ddc))
* include plenary as a dependency ([6ea1eff](https://github.com/max397574/neorg/commit/6ea1eff15d3f1fa947255a94f99cadb298c8b66f))
* **itero:** allow fallback keys for when there is no object to iterate ([ba2899d](https://github.com/max397574/neorg/commit/ba2899d6580706cbf727720db2765aead9d342de))
* **keybinds:** add `opts` arg to `remap(_event)` ([27af839](https://github.com/max397574/neorg/commit/27af839eb6833f82765bc3066ab7e9b437233dd2))
* **keybinds:** allow `core.itero.next-iteration` to fall back to a specific key ([51ca15b](https://github.com/max397574/neorg/commit/51ca15b13e9a7b107bef54c9bed94b5863b9c5d5))
* **keyinds:** add keybind for entering link traversal mode ([#1177](https://github.com/max397574/neorg/issues/1177)) ([8cf5205](https://github.com/max397574/neorg/commit/8cf52058fb7e9c3057882430ade90be5bdfb3a94))
* **latex:** async image rendering ([b1c96a0](https://github.com/max397574/neorg/commit/b1c96a049da8d534820f7452195fc9d961f3d025))
* **latex:** minimum length to render ([5a9d638](https://github.com/max397574/neorg/commit/5a9d6381581014c67219a823f149ce871f3af15d))
* **metagen:** add author field to provide persistent custom author name ([#1331](https://github.com/max397574/neorg/issues/1331)) ([e576308](https://github.com/max397574/neorg/commit/e576308243b58838ed97309bec60bf180cde3c91))
* **metagen:** allow falling back to the default template functions ([#1079](https://github.com/max397574/neorg/issues/1079)) ([8200ebc](https://github.com/max397574/neorg/commit/8200ebc5a5730a14efa2e47751a43539c8a16fb5))
* **metagen:** customize timezone and its format ([b458149](https://github.com/max397574/neorg/commit/b4581496328d47ab7912148ec030dcb3ec1951c4))
* **metagen:** more precise timestamp with HH:MM:SS and timezone ([#1052](https://github.com/max397574/neorg/issues/1052)) ([a8f7a9e](https://github.com/max397574/neorg/commit/a8f7a9eeef5c22eac626e7533eeee0ac9def72ad))
* modify deps.json to have proper version constraints ([5e9a3ef](https://github.com/max397574/neorg/commit/5e9a3ef798726fd2001d1596e6134b03f331a333))
* option to inject specific metadata instead of defaults ([#1128](https://github.com/max397574/neorg/issues/1128)) ([5509079](https://github.com/max397574/neorg/commit/55090798a2eed2dd00fc1b2774bc6bf309a3bd0b))
* prefix all keybind descriptions with "neorg" for discoverability ([15c24cd](https://github.com/max397574/neorg/commit/15c24cdb264807b09e9281e2d72b324145da1d57))
* prepare neorg.core.lib for extraction ([c4eb7e9](https://github.com/max397574/neorg/commit/c4eb7e96ea1e2a0a4b6d47e6bda4f6816a908262))
* run sync-parsers as a build step ([9dd8331](https://github.com/max397574/neorg/commit/9dd8331bc1ad42117c7173cd5501b93570db85d5))
* **selection_popup:** allow keybinds to be processed from another buffer ([603b633](https://github.com/max397574/neorg/commit/603b633b8df231fe37a338856b1dea7cd955a969))
* **summary:** add strategy which uses workspace subfolders as category ([aa8e66d](https://github.com/max397574/neorg/commit/aa8e66dd40c07a4de58f9ed93f27ab4dac9a241c))
* **summary:** reimplement nested categories ([#1274](https://github.com/max397574/neorg/issues/1274)) ([6202285](https://github.com/max397574/neorg/commit/6202285214e70efe0d861c5a4969f8ee817bc985))
* support dotrepeat for `promo` and `todo_items` ([#1105](https://github.com/max397574/neorg/issues/1105)) ([2c43e6b](https://github.com/max397574/neorg/commit/2c43e6b3252af198973cbe91f8fa7a762ff61a77))
* **tangle:** add `report_on_empty` option in `core.tangle` ([#1250](https://github.com/max397574/neorg/issues/1250)) ([cc6d8b1](https://github.com/max397574/neorg/commit/cc6d8b150de7bf806f3a191867a7f143970b5112))
* text-objects and working swap ([#1421](https://github.com/max397574/neorg/issues/1421)) ([49a3c64](https://github.com/max397574/neorg/commit/49a3c64c06dae55b5424b218dc7c6e6b643fd4f5))
* **toc:** add config for enabling synchronized cursorline in toc window ([d3cbb45](https://github.com/max397574/neorg/commit/d3cbb45b66c865b1b92b5f8b2dbd5a5fff7f1a2f))
* **toc:** add toc item filter ([#1195](https://github.com/max397574/neorg/issues/1195)) ([5c42084](https://github.com/max397574/neorg/commit/5c420844227c75390cc9fdf6047bfc49466169d9))
* **toc:** auto adjust toc vsplit width upon creation ([81f6330](https://github.com/max397574/neorg/commit/81f6330af951e89f98e8468d23a648fc32acdd2f))
* **toc:** don't scroll content window when switching to toc ([c4fc7e6](https://github.com/max397574/neorg/commit/c4fc7e629e8ea7ecc9610107622f46e888764534))
* **toc:** enable folding in toc ([218e7eb](https://github.com/max397574/neorg/commit/218e7ebbce010846c5ed6da647264c556c6a7ad4))
* **toc:** faster toc generation ([0171df1](https://github.com/max397574/neorg/commit/0171df1d0f8a6db254020e8b02ac576188ffad23))
* **toc:** support one ToC per tabpage ([d8a456b](https://github.com/max397574/neorg/commit/d8a456b7fa1b9d860fc36750b6e9a200a8eff5f3))
* **toc:** support todo status ([4ac077b](https://github.com/max397574/neorg/commit/4ac077b1f19efe63fcec4e6c744bc6a68dfc7f6a))
* **toc:** sync cursor from ToC to content buffer ([47e7c86](https://github.com/max397574/neorg/commit/47e7c86877aaae4d85c1a2add166ad6c15b8add4))
* **toc:** sync toc cursor after creating toc, scroll content to center when previewing ([cfcb51e](https://github.com/max397574/neorg/commit/cfcb51ea9a403ee7223e49d4afb0142d6d5e1659))
* **todo_items:** convert TODO item to "on hold" if all items are done but the rest are on hold ([#1339](https://github.com/max397574/neorg/issues/1339)) ([c32b238](https://github.com/max397574/neorg/commit/c32b238438a8f1130c89c13a2284961fe10e3e68))
* **todo-introspector:** correctly enumerate amounts of done/undone items ([d284488](https://github.com/max397574/neorg/commit/d2844882ec0d18d59a7b8727b893a964fe76a754))
* **todo-introspector:** display all TODOs on file entry ([80b2d33](https://github.com/max397574/neorg/commit/80b2d33b1f402b0279009442caf6cfaa9cd308f4))
* **todo-introspector:** finalize display code ([949ae96](https://github.com/max397574/neorg/commit/949ae962558d43673130159cd6bce89e4bf4febc))
* **todo-introspector:** properly handle nodes broken into two ([76e6443](https://github.com/max397574/neorg/commit/76e6443c9823470897245951f37cef0cc5b966f0))
* treesitter-based completions ([#1412](https://github.com/max397574/neorg/issues/1412)) ([79f6a49](https://github.com/max397574/neorg/commit/79f6a49b869a891bca9ce746f77781af46977e71))
* undojoin timestamp updates ([#1272](https://github.com/max397574/neorg/issues/1272)) ([fe25e93](https://github.com/max397574/neorg/commit/fe25e93336b6a71b3cb3d7fd53ab6e4cb4a125c1))
* when absolutely no parameters are supplied, load Neorg with core.defaults ([b6fb57b](https://github.com/max397574/neorg/commit/b6fb57b723c02255a9d0c0f1a8fc957fe007d9c2))


### Bug Fixes

* "Keybind not found" display causing errors ([#1215](https://github.com/max397574/neorg/issues/1215)) ([a51abd5](https://github.com/max397574/neorg/commit/a51abd53d8afc7de81e35d0a4247c3aa6ccfc76a))
* **`:h neorg`:** make link point to correct line in specs ([#1092](https://github.com/max397574/neorg/issues/1092)) ([e20d032](https://github.com/max397574/neorg/commit/e20d032ea3c485fc499f4dbc4bf7ce6afd6767ba))
* `folke/todo-comments.nvim` comments highlighting (again) ([#1094](https://github.com/max397574/neorg/issues/1094)) ([d8e2c8e](https://github.com/max397574/neorg/commit/d8e2c8e309c05a7db4ca84fc1216be38cf6a010f))
* `update-metadata` would fail to work with several parse trees in the document ([#1234](https://github.com/max397574/neorg/issues/1234)) ([5a44d3f](https://github.com/max397574/neorg/commit/5a44d3ffbd3b4fff762f8b2712ab1cfd16cff016))
* **action:** run lint action against pr head ([f367396](https://github.com/max397574/neorg/commit/f36739620410917a3119ee4299894c353a0d88af))
* add `core.todo-introspector` to the list of default modules ([5202271](https://github.com/max397574/neorg/commit/52022710d47fd66c73280f7a8d7fe2013d899224))
* **autocommands:** pass correct buffer id ([941119d](https://github.com/max397574/neorg/commit/941119d48a5e354cfbed24a4b314bb4eb401a75b))
* broken configuration merging in modules.lua ([#1062](https://github.com/max397574/neorg/issues/1062)) ([b4c7935](https://github.com/max397574/neorg/commit/b4c7935a0e692870f38ff34689fd900de40ea479))
* broken wiki ([68ea6b5](https://github.com/max397574/neorg/commit/68ea6b53b6cb58c54ac51256cdfd76eec540806c))
* broken wiki on github ([d4c10fe](https://github.com/max397574/neorg/commit/d4c10fe58519ce0d827cfc02f87832c75395045a))
* **build.lua:** install dependencies instead of the actual plugin itself (prevent conflicts) ([da25527](https://github.com/max397574/neorg/commit/da2552769b572c012ff2f0ee9c11e3a26f061252))
* **build:** attempt to fix build script by deferring code execution ([fb45f83](https://github.com/max397574/neorg/commit/fb45f836da9dd43940c3fdd182e8255bbce9d9dc))
* bump version of `norgopolis-server` to 1.3.1 ([0d8a7ec](https://github.com/max397574/neorg/commit/0d8a7ecae258e15f40e88bc3b312d2b92192743f))
* **calendar:** call `os.date` twice to generate correct weekday ([#1058](https://github.com/max397574/neorg/issues/1058)) ([61fb605](https://github.com/max397574/neorg/commit/61fb60508516b224ec78666187e70074397b37f8))
* **calendar:** display weekdays based on `nvim_strwidth` ([5eadb3c](https://github.com/max397574/neorg/commit/5eadb3cce8ab490222d12dfbb5c86372c89a5773))
* **calendar:** use `nvim_strwidth` for month names as well ([a081397](https://github.com/max397574/neorg/commit/a0813979663d5e55c481bb557c250b551042d115))
* **checkhealth:** add missing parameter to string.format ([#1386](https://github.com/max397574/neorg/issues/1386)) ([9656757](https://github.com/max397574/neorg/commit/9656757f7085e9e36d2469b8876f6b27f8e87c7b))
* **checkhealth:** fix erroneous boolean check for lazy users ([d523688](https://github.com/max397574/neorg/commit/d523688ecc6ddf5fbac9b42e0b62515c7655bed3))
* **ci:** "could not find upvalue `lib`" error ([486a148](https://github.com/max397574/neorg/commit/486a148d1bf5b7fd14f52a771a0dacc1e6839174))
* **ci:** fix abs path to libs in luarc ([#1267](https://github.com/max397574/neorg/issues/1267)) ([0edde97](https://github.com/max397574/neorg/commit/0edde97b51a5247bd4db351a38d5f36131b642f7))
* **ci:** supply correct version to the lua setup CI ([c814ef6](https://github.com/max397574/neorg/commit/c814ef68295baffefed7bfb8a48f8835f73a55a6))
* **ci:** try to fix the wiki generator with luarocks ([27ac595](https://github.com/max397574/neorg/commit/27ac595d90481bd8fa2d13290289d46287346903))
* **ci:** wrong version on typecheck ([fb23d2e](https://github.com/max397574/neorg/commit/fb23d2e78bf6ee601ed1de2a9ded23d6201f7506))
* clear extmarks on disable ([1be7808](https://github.com/max397574/neorg/commit/1be78080714b6f0cc1d77432629b91328880ce53))
* clear images at cursor after change ([9edd802](https://github.com/max397574/neorg/commit/9edd802c194ef180587c9c836ea84142927bc887))
* clear package.loaded cache when first installing neorg ([3d50b49](https://github.com/max397574/neorg/commit/3d50b49e1c1d37182c2ed94e718ecd5eed8cacd4))
* compute image dimensions before rendering ([94abd99](https://github.com/max397574/neorg/commit/94abd999cbb21d66080ee3970f41303c7093e1a6))
* conceal cursor updates ([2701e07](https://github.com/max397574/neorg/commit/2701e0770697ca10665277c0afd692567b24103d))
* **concealer:** avoid conflict between preset and custom icons ([9a0aab0](https://github.com/max397574/neorg/commit/9a0aab039b174625bfc4ff708ba32f3fc5713649))
* **concealer:** BufNewFile-&gt;FileType, get winid of bufid when rendering ([c0983ca](https://github.com/max397574/neorg/commit/c0983ca60f02e1a65e5990593726e57678e03c4a))
* **concealer:** do not render on range change if concealer is disabled ([9b0c31a](https://github.com/max397574/neorg/commit/9b0c31a5179f3881f9ff2350da22c9a5a11f32ab))
* **concealer:** don't rerender at `conceallevel` change when disabled ([#1068](https://github.com/max397574/neorg/issues/1068)) ([63a7a10](https://github.com/max397574/neorg/commit/63a7a101387550a220186cab7e85df15635f3356))
* **concealer:** ensure backwards compatibility for `vim.treesitter.foldexpr` ([5921cc4](https://github.com/max397574/neorg/commit/5921cc48cb3be616db0071fa058cfa4d6633c8a6))
* **concealer:** footnote pattern should be matched against full string ([fc09cfc](https://github.com/max397574/neorg/commit/fc09cfc25e243a82653a758bc137395f4860b6f5))
* **concealer:** more precise anticonceal feature detection ([#1056](https://github.com/max397574/neorg/issues/1056)) ([b0117a4](https://github.com/max397574/neorg/commit/b0117a40675398cb6b7f0967a52e148d5ddb6f42))
* **concealer:** revert a wrong fix, make luacheck ignore empty if branch instead (supercedes [#1080](https://github.com/max397574/neorg/issues/1080)) ([0c82917](https://github.com/max397574/neorg/commit/0c82917b89a187662cf8c1f5fc3a17153866df9b))
* **concealer:** use vim.treesitter.foldexpr for stabler folding ([53cbffb](https://github.com/max397574/neorg/commit/53cbffb7ecfcb60f19c10c72c4162978e8021959))
* **config:** add support for bsd operating systems ([#1281](https://github.com/max397574/neorg/issues/1281)) ([2bdb89c](https://github.com/max397574/neorg/commit/2bdb89c388d5c9e1956e7aab949ffb003e9a8ea5))
* **config:** delete `neovim_version` as it is no longer in use ([00f9a62](https://github.com/max397574/neorg/commit/00f9a628683b7b3f738e1d1d1a79d517c26b6ff5))
* **config:** fix luajit version detection ([237abac](https://github.com/max397574/neorg/commit/237abac43a38e4aa770bb5819f30b3d38ae5f392))
* **config:** make the type system happy ([27482dc](https://github.com/max397574/neorg/commit/27482dcee4b14ed61a10ba51261919cb45351dad))
* **core.keybinds:** type errors with events ([dbe2841](https://github.com/max397574/neorg/commit/dbe28417222e044bcbec5bb016f0d604004bcbb3))
* **core.mode:** type errors with events ([fb2c561](https://github.com/max397574/neorg/commit/fb2c561f0080b621fd2853a3190d48f885a13b6d))
* **core.neorgcmd.list:** don't accidentally open a separate file when displaying loaded modules ([eef1705](https://github.com/max397574/neorg/commit/eef1705ee78ae6e66917901da507a666743de877))
* **core.neorgcmd:** type errors with events ([1ab6236](https://github.com/max397574/neorg/commit/1ab6236a954cf2de6fe4b736a66ca5a17d85a6ff))
* **core.promo:** type errors with events ([0016fdd](https://github.com/max397574/neorg/commit/0016fdd8f2349dec1c1865f3412dbd08232b1bbd))
* **core.syntax:** remove deprecated functions, fix type errors in the code ([221bb2e](https://github.com/max397574/neorg/commit/221bb2eb10c8d7b7f62537393a9dce385d36b638))
* **core.todo-introspector:** treesitter highlighter errors ([cb4f25b](https://github.com/max397574/neorg/commit/cb4f25bca799c49a81e471aeca1d6d95322c87a6))
* **core/events:** fall back to the current window ID if it cannot be located ([22df349](https://github.com/max397574/neorg/commit/22df349df39d9401a95f7dc0e3dc13113f91a60a))
* **core/modules:** reorder comments so that they are properly parsed by luals ([f20b40a](https://github.com/max397574/neorg/commit/f20b40a44a4e96ff9fa5ed252c3a678629adfda9))
* **core:** assign custom field ([4b057ad](https://github.com/max397574/neorg/commit/4b057ad071f0e395fb1e983c9611913e9b46108f))
* **dirman:** add `raw_path` option to work with arbitrary filetype ([#1143](https://github.com/max397574/neorg/issues/1143)) ([0c9f5de](https://github.com/max397574/neorg/commit/0c9f5dea0cfe8b7c3d38f26651d82624079774ed))
* **dirman:** correctly create nested directory ([#1061](https://github.com/max397574/neorg/issues/1061)) ([4f0888b](https://github.com/max397574/neorg/commit/4f0888bdf98f7b1eeb96365aca17aa08ba4a07ea))
* **dirman:** norg link with `.` was misinterpreted as the extension ([96fe2c9](https://github.com/max397574/neorg/commit/96fe2c92d0e8fb2a2a853847909155aae4d5ca46))
* **dirman:** open index file in default workspace only if it exists ([d1bda3c](https://github.com/max397574/neorg/commit/d1bda3caf7d73ec93bed125d2d76ba32ce897789))
* **dirman:** properly escape directories and filenames ([#1232](https://github.com/max397574/neorg/issues/1232)) ([e1f5556](https://github.com/max397574/neorg/commit/e1f5556bfbe50cbae262dffc35f376f7469f68cf))
* **dirman:** respect force option in dirman create_file ([0782ca4](https://github.com/max397574/neorg/commit/0782ca4a221cfd965f05752d7178b2692bb64ae0))
* do not add the line jump of a link to the jump list ([#1325](https://github.com/max397574/neorg/issues/1325)) ([918f2a3](https://github.com/max397574/neorg/commit/918f2a39f96e1447c00871eb611bed2018a047b5))
* **docgen:** invalid upvalues ([84ee928](https://github.com/max397574/neorg/commit/84ee928cd91db8705111c3d485e2a38ca5de61ec))
* **docgen:** make the wiki work again ([d44dd38](https://github.com/max397574/neorg/commit/d44dd387d8f553791671f52f691be7580b98c6db))
* don't allow TODOs with nested items of the same type to be given the pending status ([5942fdf](https://github.com/max397574/neorg/commit/5942fdf7eb42b6364ca0a754ac88bd0ca05ae660))
* don't autoload `core.neorgcmd` nor `core.keybinds` as dependencies of other modules ([#1051](https://github.com/max397574/neorg/issues/1051)) ([62ba931](https://github.com/max397574/neorg/commit/62ba93130eb795ccc2133841ce0e541f8bc51eb7))
* don't load `core.todo-introspector` if not on nightly (oops) ([bc7830e](https://github.com/max397574/neorg/commit/bc7830ec3e538d381f5361ca80a9bc5f97fc8fa9))
* don't try to pull lua-utils when it's not applicable ([bcac799](https://github.com/max397574/neorg/commit/bcac79933f3930f04d9b1517106646a56efd8606))
* don't use deprecated `query.get_node_text()` call ([#1067](https://github.com/max397574/neorg/issues/1067)) ([7248c34](https://github.com/max397574/neorg/commit/7248c347704d658daf0fa0a84706c120e92eb1a5))
* enable source of `nvim-cmp` only norg file type ([#1298](https://github.com/max397574/neorg/issues/1298)) ([1ab15f4](https://github.com/max397574/neorg/commit/1ab15f4b30627fd5e6dd175a23c7360c2c08b2bd))
* enforce contraint on norgopolis-server ([4b9f25c](https://github.com/max397574/neorg/commit/4b9f25ca9760e89702ccbe117d1ce17780b64641))
* error in loading preventing wiki from generating ([2745ee1](https://github.com/max397574/neorg/commit/2745ee1371c1029171bb98f2d9fb258e688d2c20))
* error with import loop ([16b5479](https://github.com/max397574/neorg/commit/16b54794a545d8f80c0e9007952e374df2e417cd))
* **export.markdown:** export `authors` metadata field key as `author` ([#1319](https://github.com/max397574/neorg/issues/1319)) ([f30ce72](https://github.com/max397574/neorg/commit/f30ce728e1b99e23320114c3bddb18be2776baf7))
* **export.markdown:** fix error on unexported verbatim tags without parameters ([#1280](https://github.com/max397574/neorg/issues/1280)) ([e6d89d3](https://github.com/max397574/neorg/commit/e6d89d333aff65a771a98955fac9fc178345c01c))
* **export.markdown:** fix html `embed` tags not being exported ([5b2022c](https://github.com/max397574/neorg/commit/5b2022caaf689dc1c78b8959a2547249f8b05769))
* **export.markdown:** fix incorrect reset of ordered list item count ([#1324](https://github.com/max397574/neorg/issues/1324)) ([ba58c1b](https://github.com/max397574/neorg/commit/ba58c1b29c9b013928025db345c6ff170e9693bf))
* **export.markdown:** fix markdown `embed` tags not being exported ([f3d4230](https://github.com/max397574/neorg/commit/f3d4230d37da5d727d3ae13e1bada30e37b433ad))
* **export.markdown:** fix the first `tag` always being exported by default ([bda456d](https://github.com/max397574/neorg/commit/bda456d6685545893d446e841f2ee41633b6548a))
* **export.markdown:** use proper amount of parameters ([b0b5a43](https://github.com/max397574/neorg/commit/b0b5a4370228f27bd98516b9061bd6c87386c8f3))
* **export:** better handling of new lines in markdown metadata ([d56cc3c](https://github.com/max397574/neorg/commit/d56cc3c9a9cd10bfac5eac2514a9457a3e9e848d))
* **export:** fix metadata values being ignored when converting to markdown ([6f9b66c](https://github.com/max397574/neorg/commit/6f9b66cfa75241d4b8c0890a312872104a2d96a1))
* **export:** handle empty `object`/`array` nodes in markdown metadata ([3afbadb](https://github.com/max397574/neorg/commit/3afbadb3d116d6f8a5fb0aa3af1c06563c4a038e))
* handle switching buffers ([af4001e](https://github.com/max397574/neorg/commit/af4001ebd8678261e334591be4435f11e1aac294))
* **highlights:** always try to attach highlights when triggered ([#1025](https://github.com/max397574/neorg/issues/1025)) ([31b3bfd](https://github.com/max397574/neorg/commit/31b3bfddfc1a4e426b41879bdb1a039babc554e3))
* **highlights:** updated default groups to match names in treesitter ([56ad805](https://github.com/max397574/neorg/commit/56ad8056b6180dba60ddbd5bca2f29de12f3bd1d))
* **highlights:** updated unordered list, underline and strikethrough groups with standard names ([e7f524c](https://github.com/max397574/neorg/commit/e7f524c44f1a5d6fba6cced7e4eb3c22b9ff1473))
* **hop:** fix range check across lines ([1038016](https://github.com/max397574/neorg/commit/10380167975732444f21c882e522d15b0ec55b34))
* image flashing on text change ([19737b0](https://github.com/max397574/neorg/commit/19737b02be7aee6c4395439fbd756901adb428a1))
* incorrect code in upgrade module ([07967f1](https://github.com/max397574/neorg/commit/07967f1982b589974958689c7a055b33ea194691))
* **integrations.truezen:** use `setup()` instead of `load()` ([26cfe0e](https://github.com/max397574/neorg/commit/26cfe0e155c35695d2d4af7d938a9ffd160b8797))
* **integrations.truezen:** use `setup()` instead of `load()` ([3506236](https://github.com/max397574/neorg/commit/3506236e292de6d7989b6d6541ed5fcfa1e73bab))
* **introspector:** various bugs related to extmark updates ([e8c9193](https://github.com/max397574/neorg/commit/e8c9193b10ea946e6f90e06daf0efeafb55fa970))
* invalid vim.cmd syntax ([affdd6f](https://github.com/max397574/neorg/commit/affdd6fcbc2092fca293817d65e1664afbafe223))
* issue a more friendly error message when user loads tempus pre-Neovim `0.10.0` ([#1035](https://github.com/max397574/neorg/issues/1035)) ([333a1fd](https://github.com/max397574/neorg/commit/333a1fd67aad3dee49305b0278bd59f8ae740f13))
* issue a warning to users when dependencies cannot be found (instead of silently failing) ([04f4127](https://github.com/max397574/neorg/commit/04f4127a08a59d110c882464b11294dec0cf1258))
* **journal:** toc reset month & add link indent ([#1165](https://github.com/max397574/neorg/issues/1165)) ([16af444](https://github.com/max397574/neorg/commit/16af444ef804aa7f099c7a5ae03640dfc2b60303))
* **journal:** value assigned to variable current_quarter is unused ([0e88151](https://github.com/max397574/neorg/commit/0e8815116b08bfbceb2b36a8c82d81005e2596e0))
* lack of comma ([65c7550](https://github.com/max397574/neorg/commit/65c75508626ad02a3cb40a84c4c3df0cde7b0e5a))
* **latex:** predict image size for scale &gt; 1 ([bde2402](https://github.com/max397574/neorg/commit/bde24023d2b1ae507034c0839144f36e96dc7dc2))
* **latex:** Want image integration ([a80c025](https://github.com/max397574/neorg/commit/a80c025b231a6acd925d625d6d9ea302bc20bd49))
* limages losing track of their extmarks ([f05bce2](https://github.com/max397574/neorg/commit/f05bce247e53a53a19bfe47c57d6bc8023b5c43b))
* load default modules even if an empty table is provided as input to setup() ([c1d36ad](https://github.com/max397574/neorg/commit/c1d36add07364e024dbf39276388741e54f7e955))
* logic when inline = false ([fc8c054](https://github.com/max397574/neorg/commit/fc8c0542d8676155e8c47d0b735e816a366235b1))
* **looking-glass:** ensure both the target buffer and the source are loaded before pursuing any operations ([fba064d](https://github.com/max397574/neorg/commit/fba064db88eae3419d20ce35cf3961d02c355a8f))
* **luacheck:** setting non-standard global variables in latex renderer module ([#1176](https://github.com/max397574/neorg/issues/1176)) ([3f4b279](https://github.com/max397574/neorg/commit/3f4b279d7505ac854fcd31d1aad24991542ea5d8))
* **luarocks:** add proper dependencies ([81328d1](https://github.com/max397574/neorg/commit/81328d17ed9d5509e7dea8f1efc0fa568535e0e0))
* **luarocks:** pin `pathlib` to `2.0` (as luarocks doesn't like it otherwise) ([5b93840](https://github.com/max397574/neorg/commit/5b93840d97c2ac0d1534321ca3659f4b8c1342e4))
* mark core.links as internal ([22e7151](https://github.com/max397574/neorg/commit/22e7151f02559cea0320d02b57e59d2fb8294956))
* **meta:** fix treesitter deprecation warning ([#1104](https://github.com/max397574/neorg/issues/1104)) ([#1130](https://github.com/max397574/neorg/issues/1130)) ([5205f3f](https://github.com/max397574/neorg/commit/5205f3f1ed23545a3015021be11d35a012e3b02a))
* **modules:** Check the right config key in module.wants ([8b25435](https://github.com/max397574/neorg/commit/8b25435e8bc60f9e6f665b3a28870d64d20f2b59))
* **neorg.norg:** clarify horizontal line syntax ([#1230](https://github.com/max397574/neorg/issues/1230)) ([e35bf90](https://github.com/max397574/neorg/commit/e35bf907533281a6c641505eae3bb42100d7b5a0))
* **neorgcmd.modules.list:** add basic escape keybinds ([71e2f05](https://github.com/max397574/neorg/commit/71e2f05ee19c94705fadbc1f84e11990baf8ff1c))
* nobody figured it out so away it goes :) ([7b3e794](https://github.com/max397574/neorg/commit/7b3e794aa8722826418501608c8a3ffe4e19ea30))
* **pathlib:** bump pathlib version; fix `path:touch` ([bedbbe2](https://github.com/max397574/neorg/commit/bedbbe208e61491d1d8be0b6775793b246b444d0))
* perform setup after the parsers have been installed ([f90c965](https://github.com/max397574/neorg/commit/f90c9654352f424690327271e3bd9a2c036489d0))
* **presenter:** ensure module.private is not overriden ([#1037](https://github.com/max397574/neorg/issues/1037)) ([c9dd9f7](https://github.com/max397574/neorg/commit/c9dd9f7d506717b00e99409e4088e5b739c36b39))
* properly check for existence of a given module by trying to load it instead of passively scanning the loaded module list ([727ef2a](https://github.com/max397574/neorg/commit/727ef2ab4247b52733d1a84d87143257e783d4e9))
* properly install parsers ([59b6d61](https://github.com/max397574/neorg/commit/59b6d619213506e405a8ed13669dc82120653ac5))
* properly log TS error messages ([73db6b5](https://github.com/max397574/neorg/commit/73db6b51e9e28cce7ef17baf78a8416b563ca53a))
* properly require lua-utils ([b8a78c0](https://github.com/max397574/neorg/commit/b8a78c0c84dcfd3996480339c3d10c6e1ade8363))
* record that module `upgrade` requires at least 1 arg ([#1207](https://github.com/max397574/neorg/issues/1207)) ([51f55f5](https://github.com/max397574/neorg/commit/51f55f5c6d54fa86fdaae805b55ca88aa9607c37))
* refactor library to not use lua utils ([5fcae0b](https://github.com/max397574/neorg/commit/5fcae0b080531ac1438faeefd47ae11e1633b463))
* refresh lua cache upon succesful installation of dependencies ([f1473cf](https://github.com/max397574/neorg/commit/f1473cf9ab1c1b610758e28fcb9e8a792a51ddf4))
* remove LaTeX renderer and image.nvim integration from `core.defaults` ([5a88bcb](https://github.com/max397574/neorg/commit/5a88bcbf60590348e4196493c9c7642f23ba21d7))
* remove lua-utils from the loaded list to force a refresh ([af1e06c](https://github.com/max397574/neorg/commit/af1e06c801d6cb5682dde9a63b22053a8cf28665))
* remove old and hacky code related to nvim-treesitter's query cache invalidation ([e8d8d1e](https://github.com/max397574/neorg/commit/e8d8d1e6608e53e366109fc4f9d7ab364ea0fb5c))
* rename Neorg index message to be more insightful ([6d686cd](https://github.com/max397574/neorg/commit/6d686cdc064489ed17b49b6f1463fc9b3e5ba698))
* render images on cursor line on enable ([dc51ff4](https://github.com/max397574/neorg/commit/dc51ff489a653c292c6bf84751a5d060e8018c6c))
* rendering order for multiple img in one line ([a50c034](https://github.com/max397574/neorg/commit/a50c03432ba9cd4c370ebedfa6d84db1f0e61b6d))
* **summary:** escape ws_root special characters ([#1012](https://github.com/max397574/neorg/issues/1012)) ([32abc0d](https://github.com/max397574/neorg/commit/32abc0da29dd5bf4b42d340810b64754fd7a37b8))
* **summary:** set correct indentation for list items ([120fb52](https://github.com/max397574/neorg/commit/120fb52f5fe21c43fcc7285bac4a9bce8a54a6ec))
* **syntax:** ignore type annotation errors in syntax module ([6d94c2a](https://github.com/max397574/neorg/commit/6d94c2ac08f13208d84ce21b1e3eea13158b6491))
* **toc:** clear title after assigning prefix ([f446645](https://github.com/max397574/neorg/commit/f4466457396717d10d2d235d019e0a80e1770087))
* **toc:** fix all stylua errors ([ae38baf](https://github.com/max397574/neorg/commit/ae38baf90a319488b726ed25166fc00641b3e0ce))
* **toc:** get window id on the fly to avoid assertion errors ([1b0ab75](https://github.com/max397574/neorg/commit/1b0ab75e8e57b08bc981e0d72fe928b0fff34fe2))
* **toc:** handle buf close ([985364f](https://github.com/max397574/neorg/commit/985364f561518502cc002494db4d48ec92b00d80))
* **toc:** handle buf close ([2d65f6c](https://github.com/max397574/neorg/commit/2d65f6cf7a0f40b9a474e17bc347255514dbde0e))
* **toc:** listen cursormoved for all norg files ([19bff13](https://github.com/max397574/neorg/commit/19bff133659c16973e52546f54a13469bfecb1b6))
* **toc:** preserve heading hierarchy ([#1053](https://github.com/max397574/neorg/issues/1053)) ([1c1060f](https://github.com/max397574/neorg/commit/1c1060f0d187cd0939b05c1310bb58911e84bc22))
* **toc:** stop synching cursor when content window is hidden ([15ed981](https://github.com/max397574/neorg/commit/15ed981858658796b698f6fc204f1378eef4b01d))
* **todo-introspector:** correctly handle deletion of lines ([a8b7ad0](https://github.com/max397574/neorg/commit/a8b7ad08f6e8cd36c83e371ab9a74cc1e5252a0b))
* **todo-introspector:** do not error when a line out of bounds is deleted ([62c7925](https://github.com/max397574/neorg/commit/62c7925e17ab25cc40c50cd266701a36aa854a50))
* **todo-introspector:** properly clear namespace for refreshed buffers ([5f67407](https://github.com/max397574/neorg/commit/5f6740795303a03b58c81bf6396ae03d487d5b7c))
* TSInstallSync not found ([df6cc22](https://github.com/max397574/neorg/commit/df6cc22f36e347856bc14807b9db396e67b927d7))
* **typecheck:** fix type errors caused by autoformat ([3f531c3](https://github.com/max397574/neorg/commit/3f531c362d07d52c4956520e3798e9cfb5aeabdf))
* **typecheck:** use type definitions from nvim runtime instead ([#1358](https://github.com/max397574/neorg/issues/1358)) ([e7f393f](https://github.com/max397574/neorg/commit/e7f393f9e4a17c32289875e273f687863336894c))
* update module name to reflect breaking changes within `luarocks.nvim` ([1779e59](https://github.com/max397574/neorg/commit/1779e5962badca89505b60e9617b939489c661b0))
* use lua-utils ([b1ce837](https://github.com/max397574/neorg/commit/b1ce8374a88d638f42f0ce97b3b4b6b2b4e89023))
* use nio.scheduler to avoid double wrap ([2a9c3fa](https://github.com/max397574/neorg/commit/2a9c3fab1bb6beabc4160264835be7f3b9a579e7))
* **utils:** don't dotrepeat insert mode actions ([#1111](https://github.com/max397574/neorg/issues/1111)) ([969b3f1](https://github.com/max397574/neorg/commit/969b3f106683c66ab685ecba2a67bf11cb806785))
* various type errors in codebase ([c564e6c](https://github.com/max397574/neorg/commit/c564e6cd470e1582414b63720ef85f1d0abe1d64))
* virt text disapearing on conceallevel=0 ([acd4293](https://github.com/max397574/neorg/commit/acd4293ab269c42eb9f3294d182eb87e7a34d66b))
* work on one buffer at a time ([ba41187](https://github.com/max397574/neorg/commit/ba41187669002622b7f9778e4c49723f47faf69a))
* workspace summary ignore closed files and title field of metadata tag ([#1139](https://github.com/max397574/neorg/issues/1139)) ([d081937](https://github.com/max397574/neorg/commit/d081937a00e0f0c6966116428117e159a785abb5))


### Reverts

* backout of commit 5b93840d97c2ac0d1534321ca3659f4b8c1342e4 ([e0690fa](https://github.com/max397574/neorg/commit/e0690fa65546bd91f9aa4883f1ce4cbea45e1898))
* d8ba19a18c896cc146e7ecbd4d67bdbe03f2e0c4 ([c8e2947](https://github.com/max397574/neorg/commit/c8e2947bdb71838ce90614cb3d9a0eb530c45fd7))
* return back old logger code ([a8151f1](https://github.com/max397574/neorg/commit/a8151f1e21445739c9574d5eba9f4c635688cf98))


### Code Refactoring

* adapt to new injection syntax for treesitter ([064f8f6](https://github.com/max397574/neorg/commit/064f8f65dd32f4fe728e76acfa3e4e153b121147))
* deprecate `core.upgrade` ([45f51ed](https://github.com/max397574/neorg/commit/45f51ed759d9cdd6c69b67e57ecbd054fd4cbaba))
* **lib:** deprecate `lib.map` ([8340274](https://github.com/max397574/neorg/commit/83402746b8b43190edb360329a023040bd388294))
* **neorgcmd:** slowly move away from the deprecated `commands` directory ([560d5a0](https://github.com/max397574/neorg/commit/560d5a04fb8143aaa5e64ba8eb100df97631fa36))
* use decoupled lua-utils instead of the regular neorg utils ([5f6bf7e](https://github.com/max397574/neorg/commit/5f6bf7e5444fe839d739bd376ec5cdb362f02dc6))
